...
import {
	...
	SHARING_LOAD_REQ, SHARING_UPDATE_USER_REQ, SHARING_REMOVE_USER_REQ, SHARING_UNSHARE_REQ, SHARING_SEND_INVITES_REQ, SHARING_JOIN,
...
export const manyChangeView = (view)=>({
	type: COLLECTIONS_CHANGE_VIEW,
	view
})