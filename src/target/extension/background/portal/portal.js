window.rdportal = {
    ...
    open: function(path, mode) {
        //route loaded from actual site because of bug of safari/brave/firefox extension (local files doesn't have access)
        if (this.page.startsWith('safari') || this.page.startsWith('moz-extension') || 'brave' in navigator){
            const width = 420;
            const height = 600;
